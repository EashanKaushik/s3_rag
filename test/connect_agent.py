...
def fetch_agent_card(bearer_token: str = str()):
...
async def send_message(message: str, session_id: str, bearer_token: str = str()):
...
if __name__ == "__main__":
    ...
    while True:
        ...
        asyncio.run(send_message(user_input, session_id))
        print()
